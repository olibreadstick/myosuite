...
class WheelHoldFixedEnvV0(BaseV0):
    ...
    def _setup(self,
        ...
        self.target_jnt_value = self.sim.model.key_qpos[0].copy()[13:] # hand closing in on rail
    ...
    def get_reward_dict(self, obs_dict):
        ...
        # if self.print_counter % 50 == 0:  # Change 100 to any frequency you want
        #     print(f"=== \npost_dist: {pose_dist}\nreturn_err: {return_err:.4f}")
        #     for key, wt in self.rwd_keys_wt.items():
        #         print(f"{key}: raw={rwd_dict[key]}, weight={wt}, weighted={wt * rwd_dict[key]}")
