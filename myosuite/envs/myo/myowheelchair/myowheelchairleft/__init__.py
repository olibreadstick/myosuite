...
# WheelHold ==============================
register_env_with_variants(id='myoHandWheelHoldFixed-v0_left',
        entry_point='myosuite.envs.myo.myowheelchair.myowheelchairleft.wheelhold_v0:WheelHoldFixedEnvV0Left',
        max_episode_steps=75,
        kwargs={
            'model_path': curr_dir+'/../../assets/wheelchair/myowc+leftarm.xml',
            'normalize_act': True
        }
    )
