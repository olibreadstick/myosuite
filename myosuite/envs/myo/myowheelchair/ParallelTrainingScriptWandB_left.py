...
import myosuite.envs.myo.myowheelchair.__init__left
...
if __name__ == "__main__":
    ...
    try:
        ...
        run = wandb.init(project="myoHandWheelHoldFixed-v0_left",
    ...
    time_now = datetime.now().strftime("%Y_%m_%d_%H_%M_%S")
    log_path = f'./MPL_baselines/policy_best_model_left/{env_name}/{time_now}/'
    ...
    model = PPO('MlpPolicy_left', envs, verbose=1, ent_coef=0.001, policy_kwargs=policy_kwargs)

    # TODO TRY LOADING
    #model_num =   '2025_07_21_17_13_37'
    #model = PPO.load('./MPL_baselines/policy_best_model_left'+ '/'+ env_name + '/' + model_num + r'/best_model', envs, verbose = 1, ent_coeff = 0.01, policy_kwargs = policy_kwargs)
