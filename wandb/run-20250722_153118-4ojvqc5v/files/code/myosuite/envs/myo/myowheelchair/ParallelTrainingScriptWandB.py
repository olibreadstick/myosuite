...
if __name__ == "__main__":
    ...
    # Record actions for open-loop replay
    print("Recording actions for open-loop replay...")

    # Use a single environment for deterministic rollout
    eval_env = gym.make(env_name)
    eval_env.reset(use_grip_pose=True)

    obs = eval_env.get_obs()
    recorded_actions = []

    for _ in range(300):  # or however many steps you want
    ...
    np.save("recorded_actions.npy", recorded_actions)
    print("Saved actions to recorded_actions.npy")
